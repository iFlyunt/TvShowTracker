package com.ippt.config;

import com.ippt.security.JwtAuthenticationEntryPoint;
import com.ippt.security.filter.JWTAuthorizationFilter;
...
@Configuration
@EnableWebSecurity
@ComponentScan("com.ippt.security")
